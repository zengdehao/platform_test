...
class AddNotice(unittest.TestCase):
	def setUp(self):
		#self.url = 'http://test.admin-purchase-platform.lvyuetravel.com/mng/api/pimp/platform/notice/add.json
		#self.headers = {"Content-Type":"application/x-www-form-urlencoded","Cookie":"ly_admin_token=ea384c808d45e0847b777c34534313e99704122eb81c394ee7b523c956e7d0d2198c1818b0023e7fcd0d3cd0f81a6cbae0f0d81d69d8802312dac617bb5e6f67"}
		self.run = RunMainTest()
	
	def tearDown(self):
		pass
		
	def add_test_success(self):
